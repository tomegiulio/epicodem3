...
class primo {
    ...
    ricarica(valore) { return this.credito = this.credito + valore; }
    ;
    chiamata(minuti) {
        this.credito = this.credito - (minuti * 0.2);
...
class secondo extends primo {
    ...
    chiamata(minuti) {
        this.credito = this.credito - (minuti * 2000);
        return this.numerochiamate += 1;
    }
}
class terzo extends primo {
    ...
    chiamata(minuti) {
        this.credito = this.credito - (minuti * 0.09);
        return this.numerochiamate += 1;
    }
}
...
btnSub1 === null || btnSub1 === void 0 ? void 0 : btnSub1.addEventListener('click', function registra1() {
    let a = document.getElementById('formRicaricaIniziale1');
    a = a.value;
